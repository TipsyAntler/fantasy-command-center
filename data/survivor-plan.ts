...
export const survivorWeekPlan: SurvivorWeekPlan = {
  ...
  entries: [
    ...
    { entryNumber: 3, team: "KC", alternate: "GB", confidence: "high", rationale: "Sole surviving entry used JAX then SF. KC is available and opens around -10.5 at Miami, the strongest early Week 3 favorite. GB, also unused, is the early legal alternate around -7 vs Atlanta; SF is unavailable because Entry 3 used it in Week 2." },
  ...
  inputs: [
    ...
    { label: "Current market", state: "live", detail: "Early Week 3: KC opens about -10.5 at Miami, ahead of SF around -8.5 vs Arizona, GB around -7 vs Atlanta and BUF around -7 vs the Chargers. SF is unavailable to Entry 3 because it was used Week 2." },
