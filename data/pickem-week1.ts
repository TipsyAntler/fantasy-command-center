...
export const week1PoolGames: Week1PoolGame[] = [
  ...
  },
  {
    ...
    marketLabel: "TEN -1.5 to -2", marketTotal: 38.5, confidence: 4,
    signal: "Tennessee's frozen -1.5 remains at least as good as the live market and is a half-point better at books dealing -2.",
    rationale: "Tennessee remains the matchup lean and the live market has moved back toward the Titans. The frozen -1.5 still carries at least a small price edge versus books dealing -2.",
  ...
  },
  {
    ...
    marketLabel: "CHI -3 to -3.5", marketTotal: 47.5, confidence: 5,
    signal: "Chicago's frozen -2.5 remains better than the live market and crosses key number 3.",
    rationale: "The pool only asks Chicago to win by a field goal while the current market is around -3 or -3.5. A three-point Bears win covers in the pool while pushing or losing at the sportsbook number. Chicago remains one of the strongest frozen-price positions on the card.",
  ...
  },
  {
    ...
    signal: "Jacksonville's frozen -7.5 retains a full point of stale-line value versus the live -8.5 market.",
    rationale: "Jacksonville remains one of the strongest Week 1 favorites, and the live market is roughly -8.5 while the pool remains locked at -7.5. That creates a meaningful full-point price advantage to the submitted Jaguars side. LeQuint Allen is questionable and Cole Van Lanen is a game-time decision, but neither changes the side at this price.",
  ...
  },
  {
    ...
    marketLabel: "BUF -1.5 to PK", marketTotal: 44.5, confidence: 4,
    signal: "Houston's frozen +1.5 remains competitive with a live market ranging from pick'em to Buffalo -1.5.",
    rationale: "This remains close to a coin flip. Houston's pool +1.5 is no worse than the current consensus range and still has stale-line value wherever the live market is pick'em or Buffalo -1.",
    watch: "Because this is so tight, any late QB/OL news or a stronger directional move toward Buffalo matters."
  },
  {
    ...
    signal: "Miami's frozen +3.5 matches the live market; Brock Bowers is officially OUT.",
    rationale: "Brock Bowers' Week 1 absence still helps Miami by removing Las Vegas' top pass-game weapon. The current market is Raiders -3.5, so there is no extra stale-line edge, but the submitted Miami side remains viable at the hook.",
  ...
  },
  {
    ...
    signal: "Minnesota remains a slight favorite; frozen and live pricing are now essentially aligned.",
  ...
  },
  {
    ...
    marketLabel: "PHI -5.5", marketTotal: 44.5, confidence: 4,
    signal: "Philadelphia's frozen -4.5 is now a point better than the live -5.5 market.",
    rationale: "Philadelphia remains the preferred side based on the underlying matchup and trench advantage, and the current live line has moved beyond the frozen pool price. Washington's active 53-man roster is medically cleared, but that has not prevented the market from pricing Philadelphia more strongly.",
  ...
  },
  {
    ...
    marketLabel: "KC -2.5 to -3", marketTotal: 43.5, confidence: 5,
    signal: "Denver's frozen +3.5 remains better than the live +2.5/+3 market across key number 3.",
    rationale: "The pool gives Denver +3.5 while the current market has Kansas City around -2.5 to -3. That remains an excellent stale-line position across the NFL's most important key number. Chris Jones was newly limited Friday with a calf issue, while Josh Simmons did not practice.",
...
export const week1Tiebreaker = {
  ...
  earlyFfccTarget: 43,
  note: "Friday-night market remains around 43.5. Keep 43 as the current FFCC target and re-run the score/total model before the Sunday 10 AM PT pool deadline."
};
