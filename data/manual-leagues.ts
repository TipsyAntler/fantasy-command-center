...
export const manualLeagues: ManualLeague[] = [
  {
    ...
    snapshotLabel: "Manual snapshot updated through Sep 9",
    ...
    roster: [
      ...
      { name: "Patriots", position: "DEF", slot: "BN" },
    ],
    ir: [{ name: "TreVeyon Henderson", position: "RB", slot: "IR" }],
  },
  {
    key: "ll",
    ...
    snapshotLabel: "Aug 30 roster + IR stashes added after draft",
