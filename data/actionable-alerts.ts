...
export const actionableAlerts: ActionableAlert[] = [
  ...
  { id:"2026-w3-bowers-questionable-0926", category:"Fantasy", headline:"BM WATCH: Brock Bowers questionable after Friday DNP", detail:"Bowers was limited Wednesday/Thursday but did not practice Friday and is officially questionable vs. New Orleans. Dallas Goedert is not a usable fallback, so have a healthy TE contingency ready for Sunday in case Bowers is inactive.", href:"/leagues", active:true },
];
