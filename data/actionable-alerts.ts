...
export const actionableAlerts: ActionableAlert[] = [
  ...
  { id:"2026-w2-nyj-flip-0916-am", category:"Pick'em", headline:"PICK FLIP: GB -4.5 → NYJ +4.5", detail:"You entered GB this morning. Multiple books have Green Bay between -3.5 and -4.5, so frozen NYJ +4.5 remains the preferred side.", href:"/pickem#gb-nyj", active:true },
  { id:"2026-w2-det-restore-0916-0906", category:"Pick'em", headline:"PICK CORRECTION: restore DET +4.5", detail:"Fresh multi-book verification shows BUF -4.5, not the earlier -5.5 reference. The frozen SZN line is also BUF -4.5, so the stale-line case for Buffalo disappears. Restore Detroit +4.5.", href:"/pickem#det-buf", active:true },
];
